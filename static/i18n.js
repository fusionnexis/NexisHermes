...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    kanban_status_todo: 'Planned',
    kanban_status_ready: 'Backlog',
    kanban_status_running: 'In Progress',
    kanban_status_in_review: 'Verification',
    kanban_status_qa_verify: 'Review',
    kanban_status_blocked: 'Blocked',
    kanban_status_release_ready: 'Release Ready',
